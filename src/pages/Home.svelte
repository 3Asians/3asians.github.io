...
<main>
    ...
    <Link to="list"><button class="bg-white m-4 py-20 px-16 hover:bg-gray-200 text-blue-600 font-semibold border-4 border-blue-500 shadow items shadow-2xl" type="submit">
